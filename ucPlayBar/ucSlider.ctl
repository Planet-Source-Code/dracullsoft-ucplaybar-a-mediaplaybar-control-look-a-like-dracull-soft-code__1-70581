...
Private Sub UserControl_Resize()
        ...
        Select Case m_Orientation
            ...
            Case 0 '-- Horizontal
                If (imgSlider.Height < imgRail.Height) Then
                    Size (imgRail.Width) * pv_lTPPx, imgRail.Height * pv_lTPPx
                  Else
                    Size (imgRail.Width) * pv_lTPPx, imgSlider.Height * pv_lTPPx
                End If
            ...
            Case 1 '-- Vertical
                If (imgSlider.Width < imgRail.Width) Then
                    Size imgRail.Width * pv_lTPPy, (imgRail.Height) * pv_lTPPy
                  Else
                    Size imgSlider.Width * pv_lTPPy, (imgRail.Height) * pv_lTPPy
                End If
        End Select
    ...
    Select Case m_Orientation
        ...
        Case 0 '-- Horizontal
            With pv_uRailRect
                .y1 = (imgSlider.Height) \ 2
                .y2 = .y1
                .x1 = imgSlider.Width \ 2
                .x2 = .x1 + ScaleWidth - imgSlider.Width
            End With
                
        Case 1 '-- Vertical
            With pv_uRailRect
                .y1 = imgSlider.Height \ 2
                .y2 = .y1 + ScaleHeight - imgSlider.Height
                .x1 = (imgSlider.Width) \ 2
                .x2 = .x1
            End With
    End Select
...
Private Sub Refresh()
    ...
    If (m_RailStyle = 99) Then
        ...
        Select Case m_Orientation
            ...
            Case 0 '-- Horizontal
                Call PaintPicture(imgRail, 0, (ScaleHeight - imgRail.Height) \ 2)
                 
            Case 1 '-- Vertical
                Call PaintPicture(imgRail, (ScaleWidth - imgRail.Width) \ 2, 0)
        End Select
